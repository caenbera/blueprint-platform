...
import { ImportBlueprintDialog } from "@/components/features/marketplace/import-blueprint-dialog";
...
export function MarketplaceResourceCard({
  ...
  async function handleImport() {
    if (resource.resourceType === "blueprint") {
  ...
  return (
    <>
      ...
      {resource.resourceType === "blueprint" && (
